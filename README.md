...
#### A web implementation of chat using Flask.
...
## License
This source is free to use, but Chat does have a license which still applies and can be found on the [LICENSE](https://github.com/gunthercox/ChatterBot/blob/master/LICENSE) page.
